...
def module_main():
    ...
    try:
        ...
        ser = serial.Serial(APPLICATION['PORT'], int(APPLICATION['BAUD_RATE']), timeout=1,bytesize=data_bits,parity=parity_dict.get(APPLICATION['PARITY']), stopbits=stop_bits)
        while True:
            #  read json payload
